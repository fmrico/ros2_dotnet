    ...
    public class TestMessages
    {
        ...
        public void TestPublishNested()
        {
            ...
            while(!received)
            {
              ...
              RCLdotnet.SpinOnce(node_nested_2, 500);
            }
        ...
        {
            RCLdotnet.Init ();
            INode node_collection_1 = RCLdotnet.CreateNode ("test_collection_1");
            INode node_collection_2 = RCLdotnet.CreateNode ("test_collection_2");
            IPublisher<test_msgs.msg.Nested> chatter_pub = node_collection_1.CreatePublisher<test_msgs.msg.Nested> ("topic_collection");
            ...
            bool received=false;
            ISubscription<test_msgs.msg.Nested> chatter_sub = node_collection_1.CreateSubscription<test_msgs.msg.Nested> (
              "topic_collection", rcv_msg =>
                {
                  received=true;
                  msg2 = rcv_msg;
                }
            ...
            while(!received)
            {
              ...
              RCLdotnet.SpinOnce(node_collection_1, 500);
              RCLdotnet.SpinOnce(node_collection_2, 500);
            }
